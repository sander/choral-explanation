...
# 📄 Hoe kunnen we komen tot massaal gebruik van TIP?
Als bestuurder wil ik weten waar knelpunten en mogelijke oplossingen liggen om te komen tot massaal gebruik van TIP.

***
Vraag oorspronkelijk gesteld door [🏔️ Sander Dijkhuis](https://alkem.io/user/sander-dijkhuis-3912). [`🏔️ Origineel`](https://alkem.io/tip/collaboration/hoekunnenwekomen-4535)
...
3. Ga naar de [vraag in Alkemio](https://alkem.io/tip/collaboration/hoekunnenwekomen-4535).
4. Klik op (+).
